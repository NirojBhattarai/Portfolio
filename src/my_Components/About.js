    ...
    <section id='about'>
      <div className='container mx-auto flex px-10 md:flex-row flex-col items-center'>
        <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:text-left mb-25 md:mb-0 items-center text-center'>
          ...
          <h1 className='title-font sm:text-3xl text-2xl mb-4 font-medium text-white text-center'>Neeraj Bhattarai<br className='hidden lg:inline-block'/></h1>
        ...
        <div className="lg:max-w-lg lg:w-full md:w-2/12 w-3/12 mt-3 ">
          <img
